...
(ffi:clines "extern void draw_ellipse(int x, int y, float rx, float ry, unsigned int c);")
...
(defun draw-ellipse (x y rx ry c) (ffi:c-inline (x y rx ry c) (:int :int :float :float :unsigned-int) :void "draw_ellipse(#0, #1, #2, #3, #4)" :one-liner t))
